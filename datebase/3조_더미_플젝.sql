...
VALUES (SEQ_PROJECT.NEXTVAL, 30, 43, 1, '차세대 항암제 효능 평가', '후보물질 안전성 검사', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 30, 43, 1, '단백질 분해 기술 도입', '단백질 표적 실험',SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 30, 53, 1, '임상 1상 승인 실험', '후보물질 항암 효과 확인 실험', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 30, 53, 1, '면역항암제 안전성 승인 실험', '후보물질 임상 1상 신청', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 30, 63, 1, '차세대 항암제 안전성 개선', '항종양 효능 극대화', SYSDATE);
...
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 30, 43, 1, '신약개발 보고서 작성', '실험 자료 정리 및 도구 세척', SYSDATE);

--인사부
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 20, 5, 1, '하반기 조직개편', '임원급 사원 조직 개편', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO,  TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 20, 5, 1, '인사 실무 교육 진행', '노동관련 법정 개정부분 설명', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO,  TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 20, 5, 1, '사직서 수리', '사직서 제출 관련 법률관계 정리',  SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 20, 5, 1, '계약 만료 사원 정리', '퇴직금 정산', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 20, 5, 1, '신입사원 채용', '채용 공모서 작성', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 20, 5, 1, '실무 교육 자료 제작', '템플릿 제작 및 자료 준비', SYSDATE);

INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 20, 5, 1, '굿즈 제공 업체 선정', '업체 3곳 선정', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 20, 5, 1, '행사 포스터 제작', '레퍼런스 수집', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 20, 5, 1, '간식 제공 업체 선정', '인터넷 서칭 후 업체 선정', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 20, 5, 1, '행사 홍보', '사내 게시판에 홍보글 작성', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 20, 5, 1, '폐플라스틱 재활용 해양생물 뱃지 제작', '폐플라수틱 수거함 제작', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 20, 5, 1, '폐건전지 수거함 제작', '제작을 위한 재료 구매', SYSDATE);

--영업부
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 40, 7, 1, '국내 독점 판매 계약 체결', '수도권 대학병원 3곳과 독점 판매 계약 체결', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 40, 7, 1, '미국 제약사와 파트너링 체결', '유통허가 절차 협력 계약', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 40, 7, 1, '차세대 항암제 공동연구 계약 체결', '독일 제약사와 공동연구 시작', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 40, 7, 1, '지방거점 병원 독점 판매 계약 체결', '지방거점 대학병원 5곳과 독점 판매 계약 체결', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 40, 7, 1, '인도네시아 제약사와 허가 절차 및 유통 계약 체결', '현지 시장 조사',  SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 40, 7, 1, '독일 제약사와 허가 절차 및 유통 계약 체결', '허가 절차 승인을 위한 보고서 작성', SYSDATE);

INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 40, 7, 1, '자사 온라인몰 구축', '상표 출원 준비', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 40, 7, 1, '이커머스 플랫폼 판매 계약 체결', '판매 물량 확보 및 유통라인 정리', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 40, 7, 1, '개발 외주 업체 선정', '후보 업체 미팅', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 40, 7, 1, '이커머스 플랫폼 판매 계약 체결', '판매 계약 체결 및 유통라인 정리', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 40, 7, 1, '세무컨설팅 서비스 진행', '세무사 섭외', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 40, 7, 1, '쉼터 운영', '간식 보충 및 정리 정돈', SYSDATE);
