...
<html lang="en">
    ...
    <body>
        ...
        <div id="calendarContainer" class="calendar-container">
            ...
            <h5>휴가 승인 현황</h5>
            <div id="upperDiv">
                <div class="listBtn" onclick="location.href='/leave/listForApprover?state=0'">
                    <h5>승인 대기</h5>
                    <h4 id="waitMark">0 건</h4>
                </div>
                <div class="listBtn" onclick="location.href='/leave/listForApprover?state=1'">
                    <h5>승인 완료</h5>
                    <h4 id="approvalMark">0 건</h4>
                </div>
                <div class="listBtn" onclick="location.href='/leave/listForApprover?state=2'">
                    <h5>반려</h5>
