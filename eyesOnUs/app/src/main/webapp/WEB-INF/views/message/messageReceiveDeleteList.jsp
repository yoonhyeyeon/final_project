...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <head>
      ...
      <script defer src="/js/messageJs/messageReceiveDeleteListJs.js"></script>
      <script defer src="/js/messageJs/messageReceiveRecoverJs.js"></script>
      <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
      <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
      <link rel="stylesheet" type="text/css" href="/css/messageCss/messageFolderStyleCss.css">
      <title>삭제된 받은 메시지 함</title>
    </head>
        ...
        <div id="folderOutline">
          <div id="folderHead">
            ...
            <div id="folderHead3" class="folderTitleBar" onclick="location.href='/message/messageSendDeleteList'">삭제된 보낸
              메시지</div>
            <div id="folderHead4" class="folderTitleBar active"
          ...
          <div id="folderBody">
            ...
            <div id="deletedReceivedMessages" class="tab-content active">
