...
VALUES (SEQ_PROJECT.NEXTVAL, 30, 6, 1, '차세대 항암제 효능 평가', '후보물질 안전성 검사', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 30, 6, 1, '단백질 분해 기술 도입', '단백질 표적 실험',SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 30, 6, 1, '임상 1상 승인 실험', '후보물질 항암 효과 확인 실험', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 30, 6, 1, '면역항암제 안전성 승인 실험', '후보물질 임상 1상 신청', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 30, 6, 1, '차세대 항암제 안전성 개선', '항종양 효능 극대화', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 30, 6, 1, '신약개발 보고서 작성', '실험 자료 정리 및 도구 세척', SYSDATE);


INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 30, 6, 1, '진통제 후보물질 탐색', '분자 생성 AI로 분자구조 합성', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 30, 6, 1, '헐우병 치료 신약 후보물질 탐색', '후보물질 단백질 합성 실험', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 30, 6, 1, '바이오 선도모델 구축', '의료로봇 개발', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 30, 6, 1, '세포유전자 신약개발 탐색', '품질관리 부분 연구', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 30, 6, 1, '진통제 후보물질 탐색', '분자 생성 AI로 분자구조 합성', SYSDATE);
INSERT INTO PROJECT (NO, CODE, EMP_NO, STATE_A_NO, TITLE, CONTENT, START_DATE)
VALUES (SEQ_PROJECT.NEXTVAL, 30, 6, 1, '신약 특허 신청', '임상실험 결과 보고서 작성', SYSDATE);
