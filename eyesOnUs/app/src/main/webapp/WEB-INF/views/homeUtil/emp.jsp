...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <head>
      ...
      <link rel="stylesheet" type="text/css" href="/css/homeUtil/emp.css">
    ...
    <body id="container">
      <div id="warp">
        ...
        <section>
        <img src="https://i.pinimg.com/736x/df/3f/cc/df3fcc938891c26f7546d2b4428d2b16.jpg" style="width: 50%; height: auto;">
        </section>
