...
CREATE SEQUENCE SEQ_STATE_A NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_STATE_B NOCACHE NOCYCLE;
...
ALTER TABLE COLLEAGE_EVAL 
ADD CONSTRAINT COLLEAGE_EVAL_CK_RESPONSIBILITY 
CHECK (RESPONSIBILITY >= 0 AND RESPONSIBILITY <= 100);
...
ADD CONSTRAINT FK_TENDINOUS_REVIEW_TO_TENDINOUS 
FOREIGN KEY (NO2) 
REFERENCES TENDINOUS(NO);

ALTER TABLE TENDINOUS_REVIEW
ADD CONSTRAINT FK_TENDINOUS_REVIEW_TO_EMPLOYEE 
FOREIGN KEY (WRITER_NO) 
REFERENCES EMPLOYEE(NO);

-- 자유게시판 댓글
ALTER TABLE FREE_BOARD_REVIEW 
ADD CONSTRAINT FK_FREE_BOARD_REVIEW_TO_FREE_BOARD 
FOREIGN KEY (NO2) 
REFERENCES FREE_BOARD(NO);

ALTER TABLE FREE_BOARD_REVIEW 
ADD CONSTRAINT FK_FREE_BOARD_REVIEW_TO_EMPLOYEE 
FOREIGN KEY (WRITER_NO) 
REFERENCES EMPLOYEE(NO);
