...
<html lang="en">
    <head>
        ...
        <script defer src="/js/leave/list/listForApprover.js"></script>
    ...
    <body>
        ...
        <div id="calendarContainer" class="calendar-container">
            <div id="approveChange">
                ...
                <span id="approveChangeSpan02" onclick="location.href='/leave/listForWriter'">신청한 휴가</span>
                <span id="approveChangeSpan03" class="approveChangeSpan clickedApproveChangeSpan" onclick="location.href='/leave/listForApprover'" >승인할 휴가</span>
            </div>
            <h5>휴가 승인 현황</h5>
            <div id="upperDiv">
                <div class="listBtn">
